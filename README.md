This is a fork of cordova-plugin-camera-preview
...
use the last released version on npm

``` 

ionic cordova plugin add cordova-plugin-camera-preview-alwaysmkt

meteor add cordova:cordova-plugin-camera-preview-alwaysmkt@X.X.X

<gap:plugin name="cordova-plugin-camera-preview-alwaysmkt" />
```
